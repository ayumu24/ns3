...
NDAodvHelper* 
NDAodvHelper::Copy (void) const 
{
  return new NDAodvHelper (*this); 
}

Ptr<Ipv4RoutingProtocol> 
NDAodvHelper::Create (Ptr<Node> node) const
{
...
void 
NDAodvHelper::Set (std::string name, const AttributeValue &value)
{
  m_agentFactory.Set (name, value);
}

int64_t
NDAodvHelper::AssignStreams (NodeContainer c, int64_t stream)
{
